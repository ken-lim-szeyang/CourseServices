...
public class PrinterHelper
{
    ...
    public static Student createStudentMenu( Scanner scanner ) throws ParseException
    {
        ...
        //Delete: System.out.println( "| Enter student birth date(MM/dd/yyyy)|" );
        //Delete: DateFormat formatter = new SimpleDateFormat( "MM/dd/yyyy" );
        ...
        while (!validDate) {
            ...
            try {
                ...
                if (dateInput.equals(formatter.format(birthDate))) {
                    validDate = true;
                } else {
        ...
        // Delete: Date birthDate = formatter.parse( scanner.next() );
        System.out.println( "|-------------------------------------|" );
